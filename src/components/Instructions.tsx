				...
				<div className='instructions__popup text-left'>
					...
					<div className='instructions__content'>
						...
						<p>
							...
							existing ideas or delete them. Each idea should be represented as
							a tile on the board that displays a title, description and
						...
						<ul>
							...
							<li>
								Add the ability to sort ideas by creation date or
								alphabetically.
							</li>
						</ul>
						...
						<ul>
							...
							<li>
								Add a character countdown as the user is approaching the limit
								of their description text.
							</li>
							<li>
								Add an unobtrusive notification when an update is made to a
								tile.
							</li>
						</ul>
					</div>
